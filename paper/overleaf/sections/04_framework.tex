...
\centering
\begin{tikzpicture}[
  agent/.style={draw,align=center,font=\sffamily\footnotesize,minimum width=1.7cm,minimum height=0.75cm,fill=blue!7,inner sep=2pt},
  orch/.style={draw,align=center,font=\sffamily\footnotesize,minimum width=2.35cm,minimum height=0.8cm,fill=orange!16,inner sep=2pt},
  twin/.style={draw,align=center,font=\sffamily\footnotesize,minimum width=2.6cm,minimum height=0.75cm,fill=green!12,inner sep=2pt},
