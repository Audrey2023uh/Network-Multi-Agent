...
\caption{T1 ROC (left) and precision--recall (right) curves on frozen instance v1.1.0-INST for representative detectors, including the final \textbf{anchored} ECN-v3 head. Legend values report ROC-AUC and average precision on this instance.}
\label{fig:t1curves}
\end{figure}
