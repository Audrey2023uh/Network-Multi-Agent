...
- T1 proposed AUPRC mean: **0.1153933378137879** vs `random_forest__full` = **0.07583814878524626**
- T2 proposed AUPRC mean: **0.015253811512895054** vs `logistic__full` = **0.038043099063649714**
- Digital Twin AUPRC gain (full − no_twin): T1=**0.0005192667975750104**, T2=**0.0012788721473743596**
- Significant wins (Wilcoxon p<0.05 & Cliff's δ>0): **8/25**
...
|--------|-------|-------|----|
| `ecn_proposed__full` | 0.1154 ± [0.0442, 0.1866] | 0.7535 ± [0.6456, 0.8614] | 0.1309 ± [0.0266, 0.2352] |
...
| Task | Ablation | AUPRC |
|------|----------|-------|
| T1_anomaly | full | 0.1154 ± [0.0442, 0.1866] |
...
| T2_failure | twin_only | 0.0137 ± [0.0101, 0.0174] |
...
| T1_anomaly | `gradient_boosting__full` | 0.21875 | 0.5 |
...
## Cost
- {'per_seed_wall_s': {'n': 6, 'mean': 51.46903751670228, 'std': 0.8797933498317652, 'ci95': [50.54575101964535, 52.39232401375921], 'min': 50.38324840005953, 'max': 52.432175099966116}, 'total_wall_s': 308.81422510021366}
